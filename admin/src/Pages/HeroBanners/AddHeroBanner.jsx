 ...
 * Form for creating hero banners for the 70-30 layout (replaces HomeSlider)
 */
export const AddHeroBanner = () => {
    ...
    const handleSubmit = (e) => {
        ...
        postData("/api/heroBanners/add", formFields).then((res) => {
            setTimeout(() => {
                setIsLoading(false);
                context.alertBox("success", "Hero banner created successfully");
                history("/hero-banners/list");
            }, 2500);
        }).catch((error) => {
            setIsLoading(false);
            context.alertBox("error", "Failed to create hero banner");
        });
    };

    return (
        <section className='p-5 bg-gray-50'>
            <h2 className="text-xl font-semibold mb-4">Add Hero Banner</h2>
