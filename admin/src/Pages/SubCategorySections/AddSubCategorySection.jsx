...
/**
 * Add SubCategory Section Component
 * Form for creating subcategory navigation items
 */
export const AddSubCategorySection = () => {
    ...
    const handleSubmit = (e) => {
        ...
        postData("/api/subCategorySections/add", formFields).then((res) => {
            setTimeout(() => {
                setIsLoading(false);
                context.alertBox("success", "SubCategory section created successfully");
                history("/subcategory-sections/list");
            }, 2500);
        }).catch((error) => {
            setIsLoading(false);
            context.alertBox("error", "Failed to create subcategory section");
        });
    };

    return (
        <section className='p-5 bg-gray-50'>
            <h2 className="text-xl font-semibold mb-4">Add SubCategory Section Item</h2>
            <p className="text-gray-600 mb-6">Create navigation items for the subcategory section</p>
